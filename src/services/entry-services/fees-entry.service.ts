...
import { IEntryDataRequestBody, IEntryMainData, IEntryGridData, IFeesEntryData } from "../../types/entry.types";
import { DEFAULT_CURRENCY_CODE } from "../../constants/default.constants";
import { logger } from "../../utils/logger";

@injectable()
export class FeesEntryService {
    constructor(
    ...
    async generateEntryFromFees(data: IFeesEntryData): Promise<void> {
        ...
        const note = `Generated Entry From Contract number ${number} Fees`;
